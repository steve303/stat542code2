...
We take a large lambda range and try 10 training-and-test splits on this range, choosing a range from -1 below the minimum lambda_min value and +1 above the maximum lambda_1se value. 
```{r}
